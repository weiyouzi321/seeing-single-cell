...
const navItems = [
  { name: 'Ch0 线性代数', href: '/chapters/0-linear-algebra' },
  { name: 'Ch1 矩阵', href: '/chapters/1-matrix' },
      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="hidden sm:flex items-center gap-2 px-3 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-blue-50 dark:hover:bg-slate-800 rounded-lg transition-colors"
          >
            ...
            <span className="hidden lg:inline ml-1">Star</span>
          </a>
